...
import { Mentor, TrainStatus } from '@/shared/model/mentor.model';
    ...
    describe('Service methods', () => {
      it('should find an element', async () => {
        const returnedFromService = Object.assign(
          {
            regDatetime: format(currentDate, DATE_TIME_FORMAT),
          },
          elemDefault
        );
      ...
      it('should not create a Mentor', async () => {
      ...
      it('should not update a Mentor', async () => {
      ...
      it('should return a list of Mentor', async () => {
        const returnedFromService = Object.assign(
          {
            username: 'BBBBBB',
            linkedin: 'BBBBBB',
      ...
      it('should not return a list of Mentor', async () => {
        mockedAxios.get.mockReturnValue(Promise.reject(error));
      ...
      it('should not delete a Mentor', async () => {
